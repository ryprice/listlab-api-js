...
import {assignTaskMutationToRestJson} from 'listlab-api/mutations/AssignTaskMutation';
...
import {moveTaskMutationToRestJson} from 'listlab-api/mutations/MoveTaskMutation';
...
const taskMutationToRestJson = (mutation: TaskMuation) => {
  switch (mutation.type) {
    ...
    case TaskMutationTypes.ASSIGN_TASK:
      return assignTaskMutationToRestJson(mutation);
    ...
    case TaskMutationTypes.MOVE_TASK:
      return moveTaskMutationToRestJson(mutation);
